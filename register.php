...
<main class="main">
    <div class="register">
        ...
        <form class="registerForm" method="post" action="php/api/register.php">
            <?php
            generateInputField("text", "userName", "userName", "Użytkownik:");
            generateInputField("email", "userEmail", "userEmail", "Email:");
            //        generateInputField("text", "userPhone", "userPhone", "Telefon:");
